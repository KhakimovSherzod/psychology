  ...
  return (
    <div className='flex min-h-screen bg-linear-to-br from-slate-50 via-blue-50/20 to-indigo-50/10'>
        ...
        <div className='p-4 sm:p-6 border-b border-slate-200/60'>
          ...
          <div className='flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-slate-50 to-blue-50/50 rounded-2xl border border-slate-200/60 shadow-sm'>
            {user?.avatarUrl ? (
              ...
              <div className='w-10 h-10 sm:w-12 sm:h-12 bg-linear-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center text-white font-bold text-base sm:text-lg shadow-md'>
      ...
      <div className='flex-1 flex flex-col min-h-screen lg:ml-0'>
        ...
        <header
          className='
          hidden lg:block sticky top-0 z-30 bg-white/95 backdrop-blur-2xl 
          ...
          <div className='flex p-6 justify-between items-center'>
            ...
            <div className='flex items-center gap-3'>
              <span className='text-lg font-semibold text-gray-700'>
                Xush kelibsiz,{' '}
                <span className='text-blue-600'>{user?.name || 'Foydalanuvchi'}</span>!
              </span>
            </div>
            ...
            <div className='flex gap-4'>
              ...
              <button
                className='
                p-3 rounded-2xl bg-slate-50 hover:bg-slate-100 
              ...
              <div className='flex items-center gap-2'>
                <button
                  className='
                  px-4 py-2 rounded-xl bg-blue-50 text-blue-700 
